<template>
	<div>
		<div class="app-form">
			...
			<m-select :active-color="$store.getters.theme.themeColor" v-model="member" class="app-form-el" placeholder="是否会员"
			 :options="[{label:'会员',value:0},{label:'非会员',value:1}]"></m-select>
			<m-button class="mvi-m-2" :color="$store.getters.theme.themeColor" :sub-color="$store.getters.theme.themeTextColor"
			@click="doSearch">
				<m-icon type="search" />
